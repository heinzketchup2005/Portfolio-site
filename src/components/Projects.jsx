  ...
  return (
    <div className="flex flex-col items-center py-10 bg-neutral-950 text-neutral-300 border-b border-neutral-900 pb-4 lg:mb-35">
      ...
      <div className="flex flex-col items-center mb-10">
        <img src='src\assets\projects\todoapp.jpeg' alt="To Do List App" className="mb-4 w-64 h-64 object-cover" />
      ...
      <div className="flex flex-col items-center mb-10">
        <img src="src\assets\projects\famtrack.jpeg" alt="Family Vacation Tracker" className="mb-4 w-64 h-64 object-cover" />
      ...
      <div className="flex flex-col items-center mb-10">
        <img src="src\assets\projects\dino.jpg" alt="Hand Gesture Controlled Dino Game" className="mb-4 w-64 h-64 object-cover" />
      ...
      <div className="flex flex-col items-center mb-10">
        <img src="src\assets\projects\nlp.png" alt="Sentiment Analysis" className="mb-4 w-64 h-64 object-cover" />
      ...
      <div className="flex flex-col items-center mb-10">
        <img src="src\assets\projects\apriori.png" alt="Apriori Model for Supermarket" className="mb-4 w-64 h-64 object-cover" />
